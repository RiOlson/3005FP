-- Get Riley Olson's achievements with the description.
...
-- Get Riley Olson's schedule, replacing traiderID with the name of the trainer.
...
-- Get Riley Olson's routines
SELECT m.FName, m.LName, r.RoutineName, r.Description
FROM Routine r
JOIN Member m ON r.MemberID = m.MemberID
WHERE m.FName = 'Riley' AND m.LName = 'Olson';

-- Get the exercises and muscles they use from Riley Olson's routine.
